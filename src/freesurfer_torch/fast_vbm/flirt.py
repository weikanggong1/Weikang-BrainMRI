"""Image-facing API for the independent PyTorch affine registration.
...
from .linear import register_affine, world_to_flirt_affine
...
class FLIRTResult:
    """Reference-grid image and transforms returned by :class:`TorchFLIRT`."""
...
class TorchFLIRT:
    """Reusable PyTorch 12-DOF affine registration with FLIRT file contracts.
...
__all__ = ["FLIRTResult", "TorchFLIRT"]
