...
public:
  ...
  virtual void SetNthreads(unsigned int nthr) { throw BasisfieldException("dctfield::SetNthreads: multi-threading not implemented for dctfields"); }
  ...
  virtual void Update(const std::vector<FieldIndex>& fiv) { throw BasisfieldException("dctfield::Update for vector not yet implemented"); }
